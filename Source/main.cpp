...
int main(int argc, char *argv[])
{
...

	{
		...
		appconf.title = "No More Meat";
		appconf.title = "Button Masher";

		appconf.internal_size_w = 1280;
		appconf.internal_size_h = 1125;
		appconf.window_w = 1280;
		appconf.window_h = 1125;
		...
		*/
		...
		poro::RunPoro< ProceduralTriangles >(appconf);
